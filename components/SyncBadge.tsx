...
export const SyncBadge: React.FC = () => {
  ...
  const config = {
    ...
    error: { icon: AlertCircle, text: 'Erro de Sync', color: 'text-red-500 bg-red-50', animate: false }
  };
  ...
  return (
    <div className={cn(
      "flex items-center gap-2 px-3 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest border border-transparent transition-all",
      current.color
    )}>
